...
val primaryLightRed = Color(192, 57, 43, 255)
val primaryDarkRed = Color(137, 0, 1, 255)
val darkSurfaceHeadingColour = Color(0xFFFFFFFF)
val lightSurfaceHeadingColour = Color(0xFF000000)
...
val md_theme_dark_primary = Color(0xFFB02D21)
...
val md_theme_dark_onBackground = Color(0xFF424242)
val md_theme_dark_surface = Color(0xFF191919)
val md_theme_dark_onSurface = Color(0xFF444444)

val seed = Color(0xFFC0392B)